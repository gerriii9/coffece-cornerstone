...
const HeroSection = () => (
  <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 text-center px-6">
      ...
      <a
        href="#kontakt"
        className="inline-block border border-primary-foreground/50 bg-primary-foreground/10 backdrop-blur-sm text-primary-foreground font-body font-medium text-base md:text-lg px-10 md:px-12 py-3 md:py-4 rounded-full hover:bg-primary-foreground/20 hover:scale-105 active:scale-95 transition-all"
      >
        Objednať
      </a>
    </div>
      ...
      <div className="grid md:grid-cols-2 gap-10 md:gap-12 items-center max-w-5xl mx-auto">
        ...
        <div className="space-y-6 md:space-y-8">
          {[
            ...
            <ScrollReveal key={item.title} delay={200 + i * 150}>
      ...
      <div className="grid md:grid-cols-2 gap-10 md:gap-12 items-center max-w-5xl mx-auto">
        <div className="space-y-6 md:space-y-8">
          {[
            ...
            <ScrollReveal key={step.num} delay={100 + i * 150}>
